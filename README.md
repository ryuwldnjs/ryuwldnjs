...
- 현실에서 마주하는 불편함을 문제로 정의하고, 기술로 해결하고 싶습니다.

# Projects
### 📚 CodeMate : 백준 알고리즘 스터디 플랫폼  
> **운영 중 (2025.06.~) · 170+ 사용자 · 1인 풀스택 개발**

팀 단위로 알고리즘 문제 추천과 **학습 현황 관리**를 제공하는 스터디 플랫폼입니다.

- 🎯 **solved.ac 기반 난이도별 미션 문제 추천**
- 📧 **매일 아침 이메일 알림**으로 학습 루틴 형성
- 📊 문제 해결 인증 및 학습 현황 제공

🔗 [CodeMate 바로가기](https://codemate.kr) · [GitHub](https://github.com/codemate-kr)

----
### 🐢 NeckLife : 에어팟 기반 거북목 탐지 iOS 앱  
>  **운영 중 (2024.04.~) · 5000+ 사용자 · SW Maestro 15기 우수 프로젝트** 

에어팟 IMU 센서를 활용해 **거북목 자세를 감지하고 예방**하는 iOS 서비스입니다.

- 🐢 **에어팟 센서 기반 거북목 감지**
- 📊 자세 히스토리 제공
- ⏱️ **n분 주기 스트레칭 리마인더(타이머)** 제공

🔗 [App Store에서 보기](https://apps.apple.com/kr/app/%EB%84%A5%EB%9D%BC%EC%9D%B4%ED%94%84-necklife-%EC%97%90%EC%96%B4%ED%8C%9F%EC%9C%BC%EB%A1%9C-%EA%B1%B0%EB%B6%81%EB%AA%A9-%ED%83%90%EC%A7%80%ED%95%98%EA%B8%B0/id6553973734) · [GitHub](https://github.com/Neck-Life)
